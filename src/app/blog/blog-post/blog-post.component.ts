...
import { IBlogPostResponse, IBlogPost, IBlogComment } from "src/app/interfaces";
...
export class BlogPostComponent implements OnInit, OnDestroy {
    ...
    insertComment(data: IBlogComment) {
        this.dataService.insert(DBTables.BlogComment, data).then((response: any) => {
            if (response.success) {
                const comment = data;
    ...
    likeComment(comment: IBlogComment) {
        comment.likes++;
        this.dataService.update(DBTables.BlogComment, comment).then((response: any) => {
